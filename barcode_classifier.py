...
class BarcodeClassifier:
    ...
    def __init__(self, frame_skip=1):
        ...
        self._RED_WINDOW_LOWER = (100 - 20, 360 - 80)
        ...
        self._DETECTION_COOLDOWN = 160 / frame_skip
    ...
    def _aruco_show_detected_markers(self):
        ...
        aruco.drawDetectedMarkers(self.observation, self._bbox)

        if self._bbox_delete:
            self._bbox = None
    ...
    def _aruco_detect_markers(self):
        ...
        self._bbox, ids, self._rejected = aruco.detectMarkers(self._gray, self._aruco_dict,
